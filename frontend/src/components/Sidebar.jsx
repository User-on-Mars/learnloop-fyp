        ...
        <div className="p-3 border-t border-site-border relative" ref={menuRef}>
          ...
          {isFree && (
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 mb-2 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 hover:from-amber-100 hover:to-orange-100 transition-colors"
            >
              <svg className="w-5 h-5 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3l3.057-3L12 3.5 15.943 0 19 3l-2 7H7L5 3zM7 10h10l1 10H6l1-10z" />
              </svg>
              <span className="text-sm font-semibold text-amber-700">Upgrade to Pro</span>
            </button>
          )}
          {isPro && (
            <button
              onClick={() => navigate('/subscription')}
              className="w-full flex items-center gap-3 px-4 py-2 mb-2 rounded-xl bg-amber-50 border border-amber-100 hover:bg-amber-100 transition-colors"
            >
