        ...
        <div className="w-full max-w-7xl mx-auto px-5 py-12 sm:py-16 flex flex-col md:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="hidden md:block md:w-[45%] lg:w-1/2 md:pl-6 lg:pl-10">
            ...
            <p className="text-[#3d4a38] text-[15px] leading-relaxed max-w-sm font-medium">
              Your skill maps, streaks, and progress are waiting. Jump back in and keep building.
            </p>
          </div>
            ...
            <div className="w-full max-w-[420px]">
              <div className="relative bg-white rounded-2xl border border-[#e2e6dc] overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  {/* Flowing curves */}
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 420 600" fill="none" preserveAspectRatio="none">
                    <path d="M420 60 Q320 100 360 200 Q400 300 350 350" stroke="#a3c99a" strokeWidth="1.5" fill="none" opacity="0.15" />
                    <path d="M0 500 Q100 440 70 340 Q40 240 120 200" stroke="#4f7942" strokeWidth="1.5" fill="none" opacity="0.12" />
                    <path d="M350 0 Q330 80 400 140" stroke="#a3c99a" strokeWidth="1" fill="none" opacity="0.1" />
                    <path d="M70 600 Q90 520 30 460" stroke="#4f7942" strokeWidth="1" fill="none" opacity="0.08" />
                  </svg>
                ...
                <p className="text-sm text-[#3d4a38] font-medium mb-6">
                  ...
                  <Link to="/signup" className="text-[#2e5023] font-bold hover:underline">Sign up</Link>
                </p>
                ...
                <form onSubmit={handleLogin} autoComplete="off" className="space-y-4">
                  <div>
                    <label htmlFor="login-email" className="block text-sm font-bold text-[#1c1f1a] mb-1.5">Email</label>
                    <input
                  ...
                  <div>
                    <label htmlFor="login-pw" className="block text-sm font-bold text-[#1c1f1a] mb-1.5">Password</label>
                ...
                <div className="flex items-center gap-3 my-5">
                  ...
                  <span className="text-[11px] font-bold text-[#9aa094] uppercase tracking-widest">or continue with</span>
                  <div className="flex-1 h-px bg-[#e2e6dc]" />
                </div>
